...
public class Main2Activity extends AppCompatActivity
       ...
       protected notesRecyclerAdapter mNotesRecyclerAdapter;
       private   myJournalOpenHelper mDbOpenHelper;
       SQLiteDatabase db;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(Main2Activity.this,AddNoteActivity.class));
            }
        });
    ...
    private void initializeDisplayContent(){
        ...
        mRecyclerView.setLayoutManager(linearLayoutManager);
         ...
         noteItem[]  myNotes=manyNotes.notesArrayFaker();



        mNotesRecyclerAdapter =new notesRecyclerAdapter(this,myNotes);
